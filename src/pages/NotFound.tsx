  ...
  return (
    <MarketingLayout>
      <section className="mx-auto flex min-h-[60vh] max-w-[1120px] flex-col items-start justify-center gap-6 px-5 py-12 md:px-10">
        ...
        <p className="max-w-[48ch] text-base leading-[1.7] text-text-secondary">
        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          <Link
            to="/pricing"
            className="font-mono text-xs uppercase tracking-[0.1em] text-text-secondary transition-colors duration-200 hover:text-text-primary"
          >
            Pricing
          </Link>
          <Link
